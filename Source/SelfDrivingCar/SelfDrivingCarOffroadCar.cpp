...
#include "SelfDrivingCarOffroadCar.h"
#include "SelfDrivingCarOffroadWheelFront.h"
#include "SelfDrivingCarOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ASelfDrivingCarOffroadCar::ASelfDrivingCarOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USelfDrivingCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USelfDrivingCarOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USelfDrivingCarOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USelfDrivingCarOffroadWheelRear::StaticClass();

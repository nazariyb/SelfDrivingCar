...
#include "SelfDrivingCarSportsCar.h"
#include "SelfDrivingCarSportsWheelFront.h"
#include "SelfDrivingCarSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ASelfDrivingCarSportsCar::ASelfDrivingCarSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USelfDrivingCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USelfDrivingCarSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USelfDrivingCarSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USelfDrivingCarSportsWheelRear::StaticClass();
